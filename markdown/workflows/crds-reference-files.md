...
| **DARK** | Dark current correction | Data cubes, `dark_slope`, DQ handling, contrast stretching | [dark_reffile.ipynb](../../notebooks/crds_reference_files/dark_reffile.ipynb) |
| **SATURATION** | Saturation thresholds | Per-pixel or per-amplifier thresholds, flag handling | [saturation_reffile.ipynb](../../notebooks/crds_reference_files/saturation_reffile.ipynb) |
...
| **PHOTOM** | Photometric calibration | Conversion factors (`photmjsr`), zero points | [photom_reffile.ipynb](../../notebooks/crds_reference_files/photom_reffile.ipynb) |
