...
- **Survey and observing-strategy evaluation tools**
  ...
  - [**Footprint Visualization Tool**](../../notebooks/footprint_visualization/footprint_visualization.ipynb) determines if astronomical source coordinates are within a survey footprint as well as on-sky visualizations of APT program footprints and exposure coverage, supporting survey tiling and geometry evaluation.
